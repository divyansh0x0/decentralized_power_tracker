...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e57d5b02-be47-4b78-be59-44cd79411654",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "E:/Projects/decentralized_power_tracker/frontend/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
...
const _13aiox = eventHandler(async (event) => {
...
const _y7Div4 = eventHandler(async (event) => {
...
const _w0OHaY = lazyEventHandler(() => {
...
const _lazy_SPBOK3 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_SPBOK3, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _13aiox, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _y7Div4, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _w0OHaY, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SPBOK3, lazy: true, middleware: false, method: undefined }
];
